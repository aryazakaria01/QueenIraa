...
import QueenIraa.modules.sql.connection_sql as sql
from QueenIraa import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from QueenIraa.modules.helper_funcs import chat_status
