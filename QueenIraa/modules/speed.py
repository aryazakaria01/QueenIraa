...
from QueenIraa import dispatcher, DEV_USERS, VERSION
from QueenIraa.modules.disable import DisableAbleCommandHandler
from QueenIraa.modules.helper_funcs.chat_status import dev_plus
import QueenIraa.modules.helper_funcs.git_api as git
...
def status(bot: Bot, update: Update):
	...
	stat = "--- System Status ---\n"
	stat += f"QueenIraaRobot Version: `{VERSION}`""\n"
