...
from QueenIraa import dispatcher, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID
from QueenIraa.modules.helper_funcs.chat_status import whitelist_plus, dev_plus
from QueenIraa.modules.helper_funcs.extraction import extract_user
from QueenIraa.modules.log_channel import gloggable

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), 'QueenIraa/elevated_users.json')
