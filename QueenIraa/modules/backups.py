...
import QueenIraa.modules.sql.notes_sql as sql
from QueenIraa import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from QueenIraa.__main__ import DATA_IMPORT
from QueenIraa.modules.helper_funcs.chat_status import user_admin
from QueenIraa.modules.helper_funcs.misc import build_keyboard, revert_buttons
from QueenIraa.modules.helper_funcs.msg_types import get_note_type
from QueenIraa.modules.rules import get_rules
import QueenIraa.modules.sql.rules_sql as rulessql
from QueenIraa.modules.sql import warns_sql as warnssql
import QueenIraa.modules.sql.blacklist_sql as blacklistsql
from QueenIraa.modules.sql import disable_sql as disabledsql
from QueenIraa.modules.sql import cust_filters_sql as filtersql
import QueenIraa.modules.sql.welcome_sql as welcsql
import QueenIraa.modules.sql.locks_sql as locksql
from QueenIraa.modules.connection import connected
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("QueenIraa{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('QueenIraa{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("QueenIraa{}.backup".format(chat_id)) # Cleaning file
