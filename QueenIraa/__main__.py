...
from QueenIraa import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from QueenIraa.modules import ALL_MODULES
from QueenIraa.modules.helper_funcs.chat_status import is_user_admin
from QueenIraa.modules.helper_funcs.misc import paginate_modules
from QueenIraa.modules.connection import connected
from QueenIraa.modules.connection import connect_button
...
if START_IMG is None:
    img = "https://telegra.ph/file/53d366f2792d3fcda6e17.jpg"
else:
  img = START_IMG    
    
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("QueenIraa.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🛡Creator🛡",url="https://t.me/kang_keong17")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/kang_keong17")]]))
        return
