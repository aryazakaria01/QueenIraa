...
from QueenIraa import BOT_USERNAME, OWNER_ID
from QueenIraa.conf import get_str_key
from QueenIraa.more.pluginhelpers import convert_seconds_to_minutes as time_convert
from QueenIraa.more.pluginhelpers import fetch
from QueenIraa.pyrogramee.pyrogram import pbot
from QueenIraa import arq
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/QueenIraaRobot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
